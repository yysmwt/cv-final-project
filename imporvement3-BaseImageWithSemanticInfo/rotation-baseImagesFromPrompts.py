...
prompt_w, prompt_x, prompt_y, prompt_z, prompt_p, prompt_q = rp.gather(example_prompts, 'miku froggo lipstick pyramids moon wolf_on_rock'.split())
...
label_p = NegativeLabel(prompt_p,negative_prompt)
label_q = NegativeLabel(prompt_q,negative_prompt)
...
def save_run(name):
    folder="output-rotation-baseWithSemanticInfo: %s"%name
